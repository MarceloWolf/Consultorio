...
@Setter
@Builder
public class FullProfessionalDto {
    ...
    @NotNull(message = "Los días de trabajo son obligatorios.")
    private Set<BusinessDaysDto> businessDays;
